...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { explanation: @information.explanation, image: @information.image, title: @information.title } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { explanation: @information.explanation, image: @information.image, title: @information.title } }
